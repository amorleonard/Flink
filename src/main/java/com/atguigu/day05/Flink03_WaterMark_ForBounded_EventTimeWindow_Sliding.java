...
public class Flink03_WaterMark_ForBounded_EventTimeWindow_Sliding {
    public static void main(String[] args) throws Exception {
        ...
        //指定watermark
        SingleOutputStreamOperator<WaterSensor> andWatermarks = waterSensorSingleOutputStreamOperator.assignTimestampsAndWatermarks(
                WatermarkStrategy
        ...
        //将相同id的数据聚合到一起
        KeyedStream<WaterSensor, Tuple> keyedStream = andWatermarks.keyBy("id");
